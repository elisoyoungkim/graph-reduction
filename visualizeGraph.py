...
# example = input(''' 
#             Please enter the graph number between 1 and 23
#             to visualze is
#             (e.g., press 1 for graph G1 and Enter key to proceed next steps)\t''')
# graph = database.graph(example)
...
nx.draw_networkx_nodes(G, pos, node_size=500,nodelist=G.nodes(),node_color= 'deeppink') #mediumaquamarine
